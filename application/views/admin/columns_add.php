...
layui.use(['element','form','upload'], function(){
    ...
    form.on('submit(columnModify)', function(data){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('module/addModule') ?>',
            data: {
        ...
        <div class="layui-col-xs12 layui-col-md12">
            <div class="layui-field-box">
                <div class="layui-form-item">
                    ...
                    <input id="c_title" type="text" name="title" required lay-verify="required" placeholder="栏目名称" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                    <input type="radio" name="type" value="00" title="文章模块" checked="">
                    <input type="radio" name="type" value="01" title="案例模块">
                    <input type="radio" name="type" value="02" title="招聘模块">
                    <input type="radio" name="type" value="03" title="简介模块">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">显示位置</label>
                    <div class="layui-input-block">
                    <input type="checkbox" value="2" name="position" title="头部导航" checked>
                    <input type="checkbox" value="3" name="position" title="尾部导航" checked>
                    </div>
                </div>
                ...
                <button class="layui-btn" lay-submit lay-filter="columnModify">立即提交</button>
            </div>
        </div>
    </form>
</div>