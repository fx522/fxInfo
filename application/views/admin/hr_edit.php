...
layui.use(['element','form','laydate'], function(){
    ...
    //监听提交
    var form = layui.form;
    form.on('submit(hrModify)', function(data){
        desc_editor.sync();
        need_editor.sync();
        if($('#hr_desc').val() === '') {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('hr/editHr') ?>',
            data: {
                'data': data.field
            },
            dataType:'json',
        ...
        <div class="layui-field-box">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="hr_name" value="<?=$hr_name?>" required lay-verify="required" placeholder="职位名称" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="hr_end" value="<?=$hr_end?>"  lay-verify="fx-date" id="hr_end" autocomplete="off" placeholder="不填表示长期有效"  class="layui-input">
                </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">招聘人数</label>
                    <div class="layui-input-block">
                        <input type="text" name="hr_number" value="<?=$hr_number?>" lay-verify="fx-number" autocomplete="off" placeholder="人数为0表示若干" class="layui-input">
                    </div>
                </div>
            </div>
                ...
                <div class="layui-row">
                    <div class="layui-col-xs12 layui-col-md6">
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <textarea name="hr_desc" id="hr_desc" placeholder="职位描述" class="layui-textarea" style="width:100%; height:150px;">
                                    <?=$hr_desc?>
                                </textarea>
                            </div>
                        </div>
                    ...
                    <div class="layui-col-xs12 layui-col-md6">
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <textarea name="hr_need_desc" id="hr_need_desc" placeholder="任职要求" class="layui-textarea" style="width:100%; height:150px;">
                                    <?=$hr_need_desc?>
                                </textarea>
                            </div>
                        </div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button id="publish_post" class="layui-btn" lay-submit lay-filter="hrModify">保存修改</button>
                </div>
            </div>
        </div>
    </div>
