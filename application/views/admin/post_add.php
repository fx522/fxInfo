...
layui.use(['element','form','laydate','upload',], function(){
    ...
    form.on('submit(postSubmit)', function(data){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('content/addPost') ?>',
            data: {
                'data': data.field
            },
            dataType:'json',
    ...
    <div class="layui-col-xs12 layui-col-md8">
        <div class="layui-field-box">
            ...
            <div class="layui-form-item">
                ...
                <input type="text" name="title" required lay-verify="required" placeholder="文章标题" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-form-text">
                <div class="layui-input-block">
                <textarea name="content" id="editor_id" class="layui-textarea" style="width:100%; height:360px;"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
                <button id="publish_post" class="layui-btn" lay-submit lay-filter="postSubmit">立即发布</button>
        ...
        <div class="layui-row">
            <div class="layui-col-xs12 layui-col-md12">
                <fieldset class="layui-elem-field">
                    ...
                    <div class="layui-field-box">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="checkbox" value='1' name="is_top" title="置顶显示">
                                <input type="checkbox" value='1' name="is_recommend" title="推荐文章" checked>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                            <input type="text" name="created_by" required lay-verify="required" value=<?=$this->fx_session->user_name?> placeholder="发布者" class="layui-input">
                            </div>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset class="layui-elem-field">
                    <legend>文章封面</legend>
                    <div class="layui-field-box">
                        <input id="img-path" type="hidden" name="cover" value="">
                        ...
                        <div class="layui-upload-list fx-center">
                            ...
                            <img class="layui-upload-img fx-hide" id="coverImagePreview"  />
